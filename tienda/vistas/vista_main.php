...
<head>
    ...
    <script src="public/script/inicio.js"></script>
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <div class="texto">
                <a href="main.php">
                <div class="si"><img width="100%" src="img/logo.png" alt=""></div></a>
            </div>
            <div class="buscar">
                ...
                <!-- <input type="button" value="Buscar" class="search" id="button-search"> -->
